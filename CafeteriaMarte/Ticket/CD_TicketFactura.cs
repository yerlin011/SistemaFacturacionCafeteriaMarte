...
namespace CapaPresentacion
{
    class CD_TicketFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = " Arti          Cant   Precio    Total";   // agrega lineas de  encabezados
        ...
        public class RawPrinterHelper
        {
            ...
            public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
            {
                ...
                di.pDocName = "FACTURA DESDE PROGRAMA C# "+DateTime.Now.ToLongDateString();
                di.pDataType = "RAW";
